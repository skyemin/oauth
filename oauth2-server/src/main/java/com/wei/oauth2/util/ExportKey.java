...
public class ExportKey {
    ...
    public static void main(String args[]) throws Exception {
        ...
        export.keystoreFile = new File("D:/github/oauth2.jks");
        export.keyStoreType = "JKS";
        export.password = "mypass".toCharArray();
        export.alias = "oauth2";
        export.exportedPrivateKeyFile = new File("D:/github/key/exported-pkcs8.key");
        export.exportedPublicKeyFile = new File("D:/github/key/exported-public.key");
